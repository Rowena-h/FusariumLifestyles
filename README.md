...
4. `./submit_speciestrees_concatenation.sh` - submits concatenation-based species tree methods - [RAxML-NG](https://github.com/amkozlov/raxml-ng) (`raxmlng.sh`) and [IQ-TREE](https://github.com/iqtree/iqtree2) (`iqtree.sh`).
5. `./submit_RAxML-NG_genetrees.sh` - submits `RAxMLNG_genetrees.sh` to run RAxML-NG for individual gene trees.
6. `./submit_speciestrees_coalescent.sh` - submits coalescent-based species tree methods -[ASTRAL-III](https://github.com/smirarab/ASTRAL) (`astral.sh`) and [ASTRAL-Pro](https://github.com/chaoszhang/A-pro) (`astral-pro.sh`) using genes trees.
