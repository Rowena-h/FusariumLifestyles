...
AMAS.py concat -f phylip -d aa -i ../../gene_trees/*_aln_edit_trimmed.phy -p fus_proteins_62T_partition.txt -t ../raxml-ng/fus_proteins_62T_concat.phy -u phylip
...
#	cp ../raxml-ng/fus_proteins_62T_concat.phy partition.${i}
#done
