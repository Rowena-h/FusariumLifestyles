...
do
	BUSCO.py -i ../polishing/fusotu${STRAIN}_${ASSEMBLER}_pilon_filtered.fa -c ${NSLOTS} -o fusotu${STRAIN}_${ASSEMBLER} -m genome -l /data/SBCS-BuggsLab/RowenaHill/genome_assemblies/busco_datasets/hypocreales_odb10.2019-11-20 -sp fusarium
done
